    ...
    public static <T> void setDefaultProp(T target, Class<T> clazz) {
        ...
        for (PropertyDescriptor propertyDescriptor : descriptors) {
            ...
            try {
                ...
                throw new RuntimeException("can not set property  when get for " + target + " and clazz " + clazz + " field " +
                        fieldName);
            }
            if (String.class.isAssignableFrom(propertyDescriptor.getPropertyType()) && value == null) {
                try {
                    ...
                    throw new RuntimeException("can not set property when set for " + target + " and clazz " + clazz + " field " +
                            "" + fieldName);
                }
